 ...
 * 拍摄驾驶证
 */
public class Camera1Fragment extends Fragment implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        btnRecapture = view.findViewById(R.id.recapture);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFile = new File(getActivity().getExternalFilesDir(Environment.DIRECTORY_PICTURES), "pic1.jpg");
    }
    ...
    /**
     * Opens the camera specified by {@link Camera1Fragment#mCameraId}.
     */
